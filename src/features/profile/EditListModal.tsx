...
import { useUpdateCollectionList } from "../collection/collection";
...
export default function EditListModal({
  ...
  const form = useForm({
    ...
    onSubmit: ({ value }) => {
      ...
      if (value.description !== defaultValues.description)
        patch.description = value.description;
      if (value.isPublic !== defaultValues.isPublic)
