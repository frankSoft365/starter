...
export default function ArticleDetail() {
  ...
  const { handleAddComment, isAddingComment } = useAddComment(articleId);
    ...
    <>
      ...
      {!isLoading && !isError && article && (
        <>
          <div className="flex flex-col items-center w-full md:w-3xl mx-auto p-4">
            ...
            <div className="flex flex-row items-center justify-around w-full">
              ...
              <div className="flex flex-row">
                <div
                  className="lg:tooltip mx-1"
                  data-tip={
                    isOwnStory
                      ? t("btn.clapIsOwn")
                      : t("btn.clap", { count: article.likeCount })
                  }
                >
                  <ArticleMenuButton
                    type="button"
                  ...
                  >
                    <HandsClappingIcon
                      size={24}
                      color={isLiked ? "#676565" : meneButtonColor}
                ...
                <div
                  ...
                  data-tip={
                    isOwnStory
                      ? t("btn.repostIsOwn")
                      : t("btn.repost", { count: 20 })
                  }
                >
                  <ArticleMenuButton disable={isOwnStory}>
                    <RepeatIcon
                      size={24}
                      color={meneButtonColor}
                      weight="light"
                    />
                    {!isOwnStory && "20"}
                  </ArticleMenuButton>
          ...
          <div className="divider mb-0"></div>
          <SignedOut>
            <div className="w-full lg:w-4xl mx-auto h-48 bg-base-200 text-xl items-center text-center p-6">
              {t("comment.noAuth")}
            </div>
          </SignedOut>
          <SignedIn>
            ...
            <div
              ref={commentRef}
              className="flex flex-col items-start p-4 w-full lg:w-4xl mx-auto"
            >
              <h2 className="text-lg md:text-2xl font-bold">
                {t("comment.response", { count: article.responseNum })}
              </h2>
