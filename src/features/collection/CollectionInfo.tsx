...
import DeleteListModal from "../profile/DeleteListModal";
import EditListModal from "../profile/EditListModal";
    ...
    <Fragment>
      <div className="w-full h-full flex flex-col justify-between gap-2">
        ...
        <div className="flex items-center gap-2 mt-4">
          <span
            className={`font-bold ${detail ? "text-2xl md:text-3xl" : "text-xl md:text-2xl"}`}
          >
            {list.name}
          </span>
          {list.isDefault === 1 && (
            <span className="badge badge-xs badge-neutral shrink-0">
              {t("profile.list.defaultBadge")}
            </span>
          )}
        </div>
        {/* 第二层：描述 */}
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {removeMode ? (
            ...
            >
              ...
              >
                <CurrentUser authorId={list.userId}>
                  <li>
                    <button
                      type="button"
